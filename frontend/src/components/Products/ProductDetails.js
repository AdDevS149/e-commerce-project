...
export default function ProductDetails() {
  ...
  const productDetails = products
    ...
    .map((productDetail) => (
      ...
      <div key={productDetail._id} className='group relative p-4 border-r border-b border-gray-200 sm:p-6'>
      <div className='rounded-lg overflow-hidden bg-gray-200 aspect-w-1 aspect-h-1 group-hover:opacity-75'>
        <Link to='/products'>
          <img src={productDetail.image} alt={productDetail.item} className='w-full h-full object-center object-cover' />
        </Link>
      </div>
      <div className='pt-10 pb-4 text-center'>
        ...
        <p className='mt-4 text-base font-medium text-gray-900'>${productDetail.price}</p>
 </div>
        <button onClick={() => addToCart(productDetail)} className="text-white bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700">ADD TO CART</button>
  ...
  // );
      ...
      // <div className='details-div' key={productDetail._id}>
